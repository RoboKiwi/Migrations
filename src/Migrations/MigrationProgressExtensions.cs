...
namespace Migrations
{
    static class MigrationProgressExtensions
    {
        ...
        public static void Report(this IProgress<MigrationUpgradeProgressModel> @this, string message, params object[] args)
        {
            @this.Report(-1, message, args);
        }

        public static void Report(this IProgress<MigrationUpgradeProgressModel> @this, TraceLevel level, int progress, string message)
        {
        ...
        public static void Report(this IProgress<MigrationUpgradeProgressModel> @this, int progress, string message, params object[] args)
        {
            var line = string.Format(message, args);
